...
const restaurants = [
  { name: 'The Bayside Asian House', logo: '/assets/restaurants/bayside-asian-house-logo.jpg', hours: ['Mon-Tue: Closed', 'Wed-Fri: 5pm - 9pm', 'Sat-Sun: 11am - 2pm, 5pm - 9pm'], phone: '(07) 3488 0103', href: 'https://rabybayharbour.com.au/the-bayside-asian-house/' },
  { name: "Chop 'n Chill", logo: '/assets/restaurants/chop-n-chill-logo.jpg', hours: ['Mon-Thu: 8am - 8:30pm', 'Fri: 8am - 9:30pm', 'Sat-Sun: 7am - 9:30pm'], phone: '(07) 4801 1003', href: 'https://rabybayharbour.com.au/chop-n-chill/' },
  { name: 'Cold Rock Ice Creamery', logo: '/assets/restaurants/cold-rock-logo.jpg', hours: ['Mon-Thu: 12pm - 8:30pm', 'Fri: 12pm - 9:30pm', 'Sat: 11am - 9:30pm', 'Sun: 11am - 8:30pm'], phone: '(07) 3821 0069', href: 'https://rabybayharbour.com.au/cold-rock-ice-creamery/' },
  { name: 'Crusoe Cafe', logo: '/assets/restaurants/crusoe-cafe-logo.jpg', hours: ['Mon-Fri: 6:30am - 1:45pm', 'Sat-Sun: 6:30am - 12pm'], phone: '(07) 3286 7757', href: 'https://rabybayharbour.com.au/crusoe-cafe/' },
  { name: 'Fiction Bar & Restaurant', logo: '/assets/restaurants/fiction-logo.jpg', hours: ['11:30am - Late, 7 Days'], phone: '(07) 3488 2888', href: 'https://rabybayharbour.com.au/fiction/' },
  { name: "Hog's Breath Cafe", logo: '/assets/restaurants/hogs-breath-logo.jpg', hours: ['Mon-Fri: 11:30am - 9pm', 'Sat-Sun: 11am - 9pm'], phone: '(07) 3286 9022', href: 'https://rabybayharbour.com.au/hogs/' },
  { name: 'K Soul BBQ', logo: '/assets/restaurants/k-soul-bbq-logo.jpg', hours: ['Sun-Thurs: 11:30am - 3pm, 5:30pm - 9:30pm', 'Fri-Sat: 11:30am - 3pm, 5:30pm - 10pm'], phone: '(07) 3286 1949', href: 'https://rabybayharbour.com.au/k-soul-bbq/' },
  { name: 'Mamma Mia Trattoria Pizzeria', logo: '/assets/restaurants/mamma-mia-logo.jpg', hours: ['Mon-Tue: 5pm - 9pm', 'Wed-Thu: 11am - 2:30pm, 4:30pm - 9pm', 'Fri-Sat: 11am - 2:30pm, 4:30pm - 9:30pm', 'Sun: 11am - 3pm, 4:30pm - 9pm'], phone: '(07) 3488 0330', href: 'https://rabybayharbour.com.au/mamma-mia/' },
  { name: 'The Pursuit of Hoppiness', logo: '/assets/restaurants/pursuit-of-hoppiness-logo.jpg', hours: ['Mon-Tues: Closed', 'Wed-Fri: 11:30am - Late', 'Sat-Sun: 11am - Late'], phone: '07 3496 0849', href: 'https://rabybayharbour.com.au/the-pursuit-of-hoppiness/' },
  { name: 'Samson Fish Seafood', logo: '/assets/restaurants/samson-fish-seafood-logo.jpg', hours: ['Sun-Thu: 11am - 8pm', 'Fri-Sat: 11am - 9pm'], phone: '07 3488 2088', href: 'https://rabybayharbour.com.au/samson-fish-seafood/' },
  { name: 'Sushi Lovers', logo: '/assets/restaurants/sushi-lovers-logo.jpg', hours: ['11am - 3pm, 5pm - 9pm, 7 Days'], phone: '07 3821 6186', href: 'https://rabybayharbour.com.au/sushi-lovers/' },
  { name: 'Teppanyaki Bar', logo: '/assets/restaurants/teppanyaki-bar-logo.jpg', hours: ['Mon: Closed', 'Tue-Thu: 5:30pm - 8:30pm', 'Fri: 5:30pm - 10pm', 'Sat: 11:30am - 2pm, 5:30pm - 10pm', 'Sun: 11:30am - 2pm, 5:30pm - 8:30pm'], phone: '07 3488 0768', href: 'https://rabybayharbour.com.au/teppanyaki-bar/' },
]
